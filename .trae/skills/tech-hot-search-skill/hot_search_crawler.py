...
# 配置信息
SAVE_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'data', '热搜排行')
...
WEBSITES = [
    ...
    },
    {
        ...
        'selector': '.hot-article-item'
    },
    {
        'name': 'IT之家',
        'url': 'https://www.ithome.com/',
        'selector': '.hot-news-item'
    },
    {
        'name': '机器之心',
    ...
    return [
        {
            ...
            'link': 'https://www.36kr.com/p/2684567',
            'source': '36氪',
            'heat': 10,
            'summary': 'OpenAI今日发布GPT-5，声称性能提升10倍，支持多模态交互'
        },
        {
            'title': '苹果发布AR眼镜，售价1999美元',
            'link': 'https://www.huxiu.com/article/8765432',
            'source': '虎嗅网',
            'heat': 9,
            'summary': '苹果终于发布期待已久的AR眼镜，将于下月正式发售'
        },
        {
            'title': '特斯拉发布全自动驾驶技术，可在任何道路上行驶',
            'link': 'https://www.ithome.com/0/876/543.htm',
            'source': 'IT之家',
            'heat': 8,
            'summary': '特斯拉宣布其全自动驾驶技术已达到L4级别，可在任何道路上安全行驶'
        },
        {
            'title': 'Google发布量子计算芯片，性能突破',
            'link': 'https://www.jiqizhixin.com/articles/2026-04-25',
            'source': '机器之心',
            'heat': 7,
            'summary': 'Google Quantum AI团队发布最新量子计算芯片，量子比特数达到1000个'
        },
        {
            'title': '微软发布Windows 12，全新界面设计',
            'link': 'https://www.leiphone.com/news/20260425.html',
            'source': '雷锋网',
            'heat': 6,
            'summary': '微软今日发布Windows 12操作系统，采用全新的界面设计和AI功能'
        },
        {
            'title': '华为发布Mate 70系列，搭载麒麟9000S芯片',
            'link': 'https://www.kuaidi.com/news/20260425/12345.html',
            'source': '快科技',
            'heat': 5,
            'summary': '华为发布Mate 70系列旗舰手机，搭载最新的麒麟9000S芯片'
        },
        {
            ...
            'link': 'https://www.geekpark.net/news/20260425',
            'source': '极客公园',
            'heat': 4,
            'summary': '字节跳动发布全新AI生成视频工具，支持4K分辨率和实时渲染'
        },
        {
            ...
            'link': 'https://techcrunch.com/2026/04/25/meta-new-vr-headset/',
            'source': 'TechCrunch',
            'heat': 3,
            'summary': 'Meta发布新一代VR头显，重量减轻50%，分辨率提升2倍'
        },
        {
            ...
            'link': 'https://www.theverge.com/2026/4/25/amazon-alexa-5-0',
            'source': 'The Verge',
            'heat': 2,
            'summary': 'Amazon发布Alexa 5.0，采用最新的大语言模型，支持更自然的对话交互'
        },
        {
            ...
            'link': 'https://www.technologyreview.com/2026/04/25/new-battery-technology/',
...
def main():
    ...
    # 保存文件到正确的目录
    save_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'data', '热搜排行')
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
