// @ts-nocheck
// ============================================================
// Homepage-specific content rendering
// ============================================================
...
function getFallbackBookAnalysisData() {
    return [
        ...
        {
            id: 'book-analysis-022',
            title: '围城·方鸿渐的假文凭：知识分子的虚荣与自卑',
            category: '围城',
            icon: '🎓',
            date: '2026-05-13',
            desc: '方鸿渐买了一张假博士文凭——钱钟书用一张假纸，撕开了整个知识分子阶层的虚荣与自卑',
            fileName: '022-围城-方鸿渐的假文凭-知识分子的虚荣与自卑.md'
        },
        {
            id: 'book-analysis-023',
            title: '围城·结尾：那只老钟的隐喻',
            category: '围城',
            icon: '⏰',
            date: '2026-05-13',
            desc: '那只走慢了的老钟，敲响了方鸿渐人生的全部荒谬——钱钟书用一个物件，写出了中国文学最伟大的结尾之一',
            fileName: '023-围城-结尾-那只老钟的隐喻.md'
        },
        {
            id: 'book-analysis-024',
            title: '三体·黑暗森林法则：宇宙社会学的冷酷逻辑',
            category: '三体',
            icon: '🌌',
            date: '2026-05-13',
            desc: '"宇宙就是一座黑暗森林"——刘慈欣用两条公理和两个概念，构建了整个宇宙文明的生存法则',
            fileName: '024-三体-黑暗森林法则-宇宙社会学的冷酷逻辑.md'
        },
        {
            id: 'book-analysis-025',
            title: '三体·面壁计划：人类最后的博弈',
            category: '三体',
            icon: '🧠',
            date: '2026-05-13',
            desc: '"面壁计划"——当人类无法隐藏自己的思想，唯一的策略就是让思想本身成为武器',
            fileName: '025-三体-面壁计划-人类最后的博弈.md'
        },
        {
            id: 'book-analysis-026',
            title: '平凡的世界·孙少平的苦难美学：路遥的生命哲学',
            category: '平凡的世界',
            icon: '🌾',
            date: '2026-05-13',
            desc: '"苦难是人生的财富"——路遥用孙少平的一生，证明了这句话不是鸡汤，而是血淋淋的真理',
            fileName: '026-平凡的世界-孙少平的苦难美学-路遥的生命哲学.md'
        },
        {
